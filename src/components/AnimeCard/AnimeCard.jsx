function AnimeCard({ image, title }) {
  return (
    <div className="group flex justify-center hover:scale-105 transition ease-out mt-10 relative max-w-sm bg-black cursor-pointer rounded-lg shadow-md hover:bg-gray-25 dark:bg-gray-800 dark:border-gray-700 dark:group-hover:bg-gray-900">
